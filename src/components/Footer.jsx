			...
			<div className="absolute inset-0 w-full h-full flex p-20">
				...
				<div className="flex flex-col text-white h-full ml-auto justify-center text-2x space-y-10">
					...
					<div className="flex space-x-8">
						<p className="flex space-x-4"><span class="material-symbols-outlined">mail</span><span>sweepingmasters@gmail.com</span></p>
						<p className="flex space-x-4"><span class="material-symbols-outlined">phone_in_talk</span><span>sweepingmasters@gmail.com</span></p>
					</div>
