...
const RootLayout = () => {
    return (
        <>
        <header className ="shadow-md sticky top-0 p-6 font-inter z-10 bg-white">
            <div className="container mx-auto flex items-center content-end md:justify-between">
                ...
                <nav className="flex flex-col md:space-y-10">
                    ...
                    <div className="navlinks flex gap-12 items-center overflow-auto uppercase font-semibold text-primary">
